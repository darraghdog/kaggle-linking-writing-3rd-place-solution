...
#model
cfg.model = "mdl_dh_15f_ch" # "mdl_dh_05s3"
#cfg.backbone = 'microsoft/deberta-v3-base'
#cfg.backbone = 'weights/pretrain_mlm_v01/checkpoint-1000/'
#cfg.backbone = 'weights/pretrain_mlm_v06/microsoft/deberta-v3-base/checkpoint-3000/'
#cfg.backbone = "weights/pretrain_mlm_v06b/microsoft/deberta-large/checkpoint-5000/"
cfg.backbone = "weights/pretrain_mlm_v06i/microsoft/deberta-v3-large/checkpoint-5000/"
cfg.backbone_cfg = {"attention_probs_dropout_prob": 0.,
         "hidden_dropout_prob": 0.}
cfg.feat_dim = 256
cfg.feat_init_ksize = 21
cfg.freeze_until = 'encoder.layer.18.' 
...
cfg.tokenizer = 'microsoft/deberta-v3-large'
cfg.padding = True
cfg.truncation = True
cfg.max_length = 3200
