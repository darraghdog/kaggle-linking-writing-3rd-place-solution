...
arg('--input_df', type=str, default="datamount/persuade_2.0_human_scores_demo_id.csv.gz")
arg('--outdir', type=str, default='weights/pretrain_mlm_v06e4')
...
data = pd.read_csv(args.input_df)
